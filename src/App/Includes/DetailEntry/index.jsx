        ...
        <div className="row mt-3 detail" data-theme={props.theme} data-device={props.device}>
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-3">
                        ...
                        <div className="col info">
                            ...
                            <InfoNovel info="Update Chapter Terakhir" data="239" />
                            <InfoNovel 
                                info="Rating" 
                                data={
            ...
            <div className="col-12 col-md-3 ">
                <div className="p-3 bg-primary text-white">
                    <div className="h6 mb-0">Latest Chapter</div>
                </div>
                <div className="w-100 bg-light p-2">
                    <div className="row">
                        <div className="col-2">
                            <img src={detail.image} alt="poster" className="w-100" />
                        </div>
                        <div className="col-8">
                            <div className="description font-10">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos impedit laudantium vitae! Praesentium facere non, alias id vel beatae hic aspernatur sunt qui, quisquam excepturi voluptatem provident sint amet. Atque?
                            </div>
                        </div>
                    </div>
                </div>
