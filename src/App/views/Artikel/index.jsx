                    ...
                    <div className="col-12 py-2 col-md-9 px-1">
                        <article className="entry-inner" data-theme={props.theme}>
                            ...
                            <div className="entry-content px-2">
                                ...
                                <p>Saat aku berpura-pura tidak menyadari lirikan genitnya, kami tiba di pintu kantor dan ketika aku memasuki ruangan aku dapat mendengar sebuah suara ‘cih’….. dia mendecakkan lidahnya, apakah itu hanya imajinasiku?</p>
                            </div>
                        </article>
                        <hr/>
                    </div>
